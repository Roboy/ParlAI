...
python3 roboy_training.py -hs 2048 -emb 300 -nl 2 -bs 128 -lr 0.0001 -dr 0.3 -ltim 15 -stim 900 -vtim 300 -vp 10 -vmt ppl -vmm min -tr 100 &>../../../data/models/convai2/profilememory/logging/log.txt
