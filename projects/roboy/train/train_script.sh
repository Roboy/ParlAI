...
python3 roboy_training.py -hs 1024 -emb 300 -nl 4 -bs 128 -lr 0.001 -dr 0.2 -ltim 15 -stim 900 -vtim 180 -vp 15 -vmt f1 -vmm max -tr 150 &>../../../data/models/convai2/profilememory/logging/log.txt
