...
python3 roboy_training.py -hs 736 -emb 300 -nl 3 -bs 32 -lr 0.0001 -dr 0.3 -ltim 15 -stim 1800 -vtim 180 -vp 20 -vmt f1 -vmm max -tr 100 &>../../../data/models/convai2/profilememory/logging/log.txt
