...
python3 roboy_training.py -hs 1536 -emb 300 -nl 2 -bs 32 -lr 0.01 -dr 0.3 -ltim 15 -stim 900 -vtim 180 -vp 10 -vmt ppl -vmm min -tr 100 &>../../../data/models/convai2/profilememory/logging/log.txt
