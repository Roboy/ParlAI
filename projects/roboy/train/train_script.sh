...
python3 roboy_training.py -hs 763 -emb 300 -nl 2 -bs 64 -lr 0.0001 -dr 0.2 -ltim 15 -stim 1800 -vtim 180 -vp 10 -vmt f1 -vmm max -tr 100 &>../../../data/models/convai2/profilememory/logging/log.txt
