...
python3 roboy_training.py -hs 1024 -emb 300 -nl 4 -bs 128 -lr 0.00001 -dr 0.5 -ltim 15 -stim 1800 -vtim 180 -vp 30 -vmt f1 -vmm max -tr 100 &>../../../data/models/convai2/profilememory/logging/log.txt --model-file ~/ss18_showmaster/ParlAI/data/models/convai2/profilememory/180812_1405/roboy_profilemem --dict-file ~/ss18_showmaster/ParlAI/data/models/convai2/profilememory/180812_1405/roboy_profilemem.dict
