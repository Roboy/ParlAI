...
python3 roboy_training.py -hs 2048 -emb 300 -nl 2 -bs 128 -lr 0.001 -dr 0.5 -ltim 15 -stim 900 -vtim 180 -vp 5 -vmt ppl -vmm min -tr 100 &>../../../data/models/convai2/profilememory/logging/log.txt
