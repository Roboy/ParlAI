...
python3 roboy_training.py -hs 2048 -emb 300 -nl 1 -bs 128 -lr 0.0001 -dr 0.25 -ltim 15 -stim 900 -vtim 300 -vp 20 -vmt f1 -vmm max -tr 100 &>../../../data/models/convai2/profilememory/logging/log.txt
