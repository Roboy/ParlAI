...
python3 roboy_training.py -hs 1536 -emb 200 -nl 1 -bs 128 -lr 0.0001 -dr 0.15 -ltim 15 -stim 900 -vtim 180 -vp 10 -vmt ppl -vmm min -tr 100 &>../../../data/models/convai2/profilememory/logging/log.txt
