...
python3 roboy_training.py -hs 1536 -emb 300 -nl 3 -bs 128 -lr 0.001 -dr 0.5 -ltim 15 -stim 1800 -vtim 180 -vp 15 -vmt f1 -vmm max -tr 150 &>../../../data/models/convai2/profilememory/logging/log.txt
