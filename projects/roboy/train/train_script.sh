...
python3 roboy_training.py -hs 1536 -emb 300 -nl 4 -bs 128 -lr 0.0001 -dr 0.4 -ltim 15 -stim 1800 -vtim 300 -vp 25 -vmt f1 -vmm max -tr 150 &>../../../data/models/convai2/profilememory/logging/log.txt
