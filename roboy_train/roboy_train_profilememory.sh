...
python3 train_roboy.py -hs 2048 -emb 256 -nl 2 -bs 256 -lr 0.001 -dr 0.25 -ltim 30 -stim 900 -vtim 450 -vp 50 -vmt ppl -vmm min -tr 100 &>../data/models/convai2/profilememory/logging/log.txt
