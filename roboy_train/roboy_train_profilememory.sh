...
python3 train_roboy.py -hs 1024 -emb 300 -nl 3 -bs 64 -lr 0.001 -dr 0.5 -ltim 30 -stim 900 -vtim 450 -vp 50 -vmt f1 -vmm max -tr 100 &>../data/models/convai2/profilememory/logging/log.txt
